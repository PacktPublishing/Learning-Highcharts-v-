...
if (isset($typeString)) {
	...
	// Do the conversion
	//$output = shell_exec("java -Djava.security.manager -Djava.security.policy=.java.policy  -jar ". BATIK_PATH ." $typeString -d $outfile $width temp/$tempName.svg");
	$image = new Imagick();
	$image->readImageBlob(file_get_contents(temp/$tempName.svg));
